...
const PaymentModal: React.FC<PaymentModalProps> = ({ squareId, onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    // Assuming you still want to handle the image file upload or any data processing
    ...
    reader.onloadend = async () => {
      ...
      try {
        const gumroadProductUrl =
          "https://2692036947524.gumroad.com/l/rentsquare";
        window.open(gumroadProductUrl, "_blank");
        onClose();
      } catch (error) {
        const errorMessage =
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div
        ref={modalRef}
        className="text-black relative bg-white p-6 shadow-lg z-50 w-80 rounded-lg"
      >
